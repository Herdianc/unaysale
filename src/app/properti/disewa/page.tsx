...
export const metadata: Metadata = {
  title: "Properti Disewa - UNAYSALE",
  description:
    "Temukan properti terbaik untuk disewa di seluruh Indonesia. Rumah, apartemen, ruko, villa, dan gudang.",
}
...
export default async function DisewaPage({ searchParams }: PageProps) {
        ...
        <div className="flex gap-6">
          <aside className="hidden lg:block w-72 flex-shrink-0">
            <div className="sticky top-20">
              <FilterPanel baseUrl="/properti/disewa" />
            </div>
          </aside>
          ...
          <div className="flex-1 min-w-0">
            ...
            <PropertyGrid
              ...
              emptyMessage="Tidak ada properti disewa yang sesuai dengan pencarian Anda."
            />
