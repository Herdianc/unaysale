...
export const metadata: Metadata = {
  title: "Properti - UNAYSALE",
  description:
    "Jelajahi properti terbaik di seluruh Indonesia. Cari rumah, apartemen, tanah, ruko, villa, dan gudang untuk dijual atau disewa.",
}
...
export default async function PropertyListingPage({ searchParams }: PageProps) {
  ...
  if (tipe) {
    const types = tipe.split(",").filter(Boolean)
    if (types.length === 1) {
  ...
  const [properties, total, categories] = await Promise.all([
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <PropertyGrid
              ...
              emptyMessage="Tidak ada properti yang sesuai dengan pencarian Anda."
            />
